...
#define PROGRAM_NAME		"infected-mod rvn-miner Miner"
...
int main(int argc, char *argv[])
{
	...
	printf("*** infected-mod rvn-miner " PACKAGE_VERSION " for nVidia GPUs by infected_ ***\n");
	if (!opt_quiet) {
	...
	if (dev_donate_percent == 0.0) {
		printf("Dev donation is 0%, please consider donate to the following addresses:\n");
		printf("RVN donation address: RNjabD9ua3DPWXSrfkQJXKeuUZjktjzb2K (infected_)\n");
		printf("RVN donation address : RSB3YesT18L2ERJS7oxhKc1mVR5tZLkdsR (--Banshee)\n\n");
		printf(" ");
	}
	else {
		printf("There's no need to set dev donation, it's off by default. If you want to support, consider a donation!\n\n", dev_donate_percent);
	}
